...
def create_casting(casting: Casting):
    new_casting = {"id": casting.id, "castingDate": casting.castingDate,"name": casting.name, "castingDirector": casting.castingDirector, "director": casting.director, "inPerson": casting.inPerson, "inProcess": casting.inProcess, "notes": casting.notes}
...
def update_casting(id: str, casting: Casting):
    result = conn.execute(castings.update().values(castingDate= casting.castingDate,
    name= casting.name,
